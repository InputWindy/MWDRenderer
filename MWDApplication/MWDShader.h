...
public:
    ...
    // 用于设置Sampler===================================
    void setSampler(const std::string& name, int tex_unit) const
    {
        glActiveTexture(tex_unit);
        glUniform1i(glGetUniformLocation(ID, name.c_str()), tex_unit);
    }
    // ------------------------------------------------------------------------
